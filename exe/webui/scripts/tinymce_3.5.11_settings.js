...
var $exeTinyMCE = {
    ...
    buttons2 : "undo,redo,|,cut,copy,paste,pastetext,pasteword,|,pastehtml,pastecode,pastemath,|,search,replace,|,link,unlink,anchor,tooltip,|,image,media,exeeffects,exegames,|,removeformat,cleanup,|,insertdate,inserttime,advhr,cite,abbr,acronym,del,ins,attribs,nonbreaking,|,charmap,exemath,|,styleprops",
